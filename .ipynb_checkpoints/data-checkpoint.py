...
train_num_dict = {
    # '1':[66,186,21,31,13,50,13,37,9],#10%
    '1':[132,372,42,62,26,100,26,74,18],#20%
    '2': [5, 143, 83, 24, 48, 73, 3, 48, 2, 97, 246, 59, 21, 127, 39, 9],#10%
    # '2': [2, 71, 41, 12, 24, 36, 2, 24, 1, 48, 123, 29, 10, 63, 19, 4],#5%
    ...
    3486,1328,4040],
    # '7':[345,84,30,632,42,119,671,71,52]#1%
    # '7':[35,8,3,63,4,12,67,7,5]#0.1%
    '7':[172,42,15,316,21,59,335,35,26]#0.5%
                  }
